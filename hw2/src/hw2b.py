...
class myMLP(object):
    """MY Multi-Layer Perceptron Class
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out, activation_mode, layers):
        """Initialize the parameters for the multilayer perceptron
        ...
        for l in range(layers):
            ...
            input_layer=self.hiddenLayer.output
            n_in=n_hidden
            #W_tmp=self.hiddenLayer.W
            #b_tmp=self.hiddenLayer.b
            self.W=self.W+[self.hiddenLayer.W]
            self.b=self.b+[self.hiddenLayer.b]
        ...
        print('myMLP Params', self.params)
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             batch_size=20, n_hidden=500, verbose=False, activation_mode=T.tanh, layers=2, use_myMLP=True):
    """
